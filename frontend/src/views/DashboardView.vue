    ...
    <div class="space-y-8">
        ...
        <div v-else>
            <div>
                ...
                <h2
                    class="text-xl sm:text-2xl md:text-3xl font-semibold text-indigo-300 mb-4 sm:mb-6 flex items-center">
                            ...
                            <tr v-for="quote in dashboardData.content" :key="quote.id"
                                ...
                                <td class="px-4 sm:px-6 py-4 text-sm font-medium space-x-2">
                                    <button @click="deleteQuote(quote.id)"
                                        ...
                                        <span
                                            class="material-icons-outlined transform group-hover:scale-110">delete</span>
                                    </button>
                                </td>
                            </tr>
                        </tbody>
